...
INSERT INTO `__efmigrationshistory` VALUES ('20250919054522_InitialCreate','8.0.13'),('20250922015046_InitialCreate','8.0.13'),('20250922015118_AddHasHelperToDriver','8.0.13'),('20250923035850_AddHasHelperColumn','8.0.13');
...
CREATE TABLE `route_optimizations` (
  ...
  CONSTRAINT `FK_route_optimizations_routes_route_id` FOREIGN KEY (`route_id`) REFERENCES `routes` (`id`),
...
-- Dump completed on 2025-09-25 10:38:38
