...
INSERT INTO `__efmigrationshistory` VALUES ('20250919054522_InitialCreate','8.0.13');
...
CREATE TABLE `attendance` (
  ...
  `driver_id` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `approved_by` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` datetime(6) NOT NULL,
  `updated_at` datetime(6) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IX_attendance_approved_by` (`approved_by`),
  KEY `IX_attendance_driver_id` (`driver_id`),
  CONSTRAINT `FK_attendance_drivers_driver_id` FOREIGN KEY (`driver_id`) REFERENCES `drivers` (`user_id`) ON DELETE CASCADE,
...
CREATE TABLE `drivers` (
  ...
  `contact_number` longtext COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `IX_drivers_license_number` (`license_number`),
  UNIQUE KEY `IX_drivers_user_id` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `drivers` VALUES ('driver-1','Juan Dela Cruz','09171234567',1,'DL-123456','B','2027-01-01 00:00:00.000000',5,10000,4.5,NULL,1,14.5995,120.9842,'2025-09-20 10:27:11.000000','2025-09-20 10:27:11.000000','2025-09-20 10:27:11.000000','user-1');
...
CREATE TABLE `leave_requests` (
  ...
  `supporting_documents` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` datetime(6) NOT NULL,
  `updated_at` datetime(6) NOT NULL,
  PRIMARY KEY (`id`),
  ...
  CONSTRAINT `FK_leave_requests_drivers_driver_id` FOREIGN KEY (`driver_id`) REFERENCES `drivers` (`user_id`) ON DELETE CASCADE,
...
CREATE TABLE `maintenance_tasks` (
  ...
  `technician_notes` longtext COLLATE utf8mb4_unicode_ci,
  `parts_used` longtext COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `route_optimizations` (
  ...
  `optimization_algorithm` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `optimized_at` datetime(6) NOT NULL,
  `optimized_by` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `IX_route_optimizations_route_id` (`route_id`),
  KEY `IX_route_optimizations_optimized_by` (`optimized_by`),
  CONSTRAINT `FK_route_optimizations_routes_route_id` FOREIGN KEY (`route_id`) REFERENCES `routes` (`id`) ON DELETE CASCADE,
...
CREATE TABLE `route_stops` (
  ...
  CONSTRAINT `FK_route_stops_routes_route_id` FOREIGN KEY (`route_id`) REFERENCES `routes` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `routes` (
  ...
  `description` longtext COLLATE utf8mb4_unicode_ci,
  `vehicle_id` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL,
  `driver_id` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  CONSTRAINT `FK_routes_drivers_driver_id` FOREIGN KEY (`driver_id`) REFERENCES `drivers` (`user_id`) ON DELETE CASCADE,
...
INSERT INTO `users` VALUES ('f03c0990-8cbd-4bef-8e2d-a07ed4e47d33','admin','admin@test.com','$2a$11$7W8QANDdY1SrqCgkSBRg1OD1Xc3LDZnUwTME2iJLTYhaUwAUpEP5C','Admin',NULL,NULL,NULL,NULL,NULL,'Active',NULL,'2025-09-20 02:53:02.196003','2025-09-20 02:53:02.196021'),('user-1','Juan Dela Cruz','driver1@test.com','123456','Driver',NULL,NULL,NULL,NULL,NULL,'Active',NULL,'2025-09-20 10:26:58.000000','2025-09-20 10:26:58.000000');
...
CREATE TABLE `vehicles` (
  ...
  CONSTRAINT `FK_vehicles_vehicle_categories_category_id` FOREIGN KEY (`category_id`) REFERENCES `vehicle_categories` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `vehicles` VALUES ('veh-1',1,'Isuzu','Giga',2020,'ABC-1234','White','Diesel',200.00,15000.00,'Ready',NULL,NULL,NULL,NULL,100.00,'2026-12-31 00:00:00.000000','2026-06-30 00:00:00.000000','POL123456',NULL,NULL,'2025-09-20 10:29:49.000000','2025-09-20 10:29:49.000000'),('veh-2',1,'Fuso','Fighter',2019,'XYZ-5678','Blue','Diesel',180.00,22000.00,'Maintenance',NULL,NULL,NULL,NULL,50.00,'2026-11-30 00:00:00.000000','2026-05-31 00:00:00.000000','POL654321',NULL,NULL,'2025-09-20 10:29:49.000000','2025-09-20 10:29:49.000000'),('veh-3',1,'Hino','Ranger',2021,'LMN-2468','Red','Diesel',210.00,12000.00,'Not Available',NULL,NULL,NULL,NULL,75.00,'2027-01-15 00:00:00.000000','2026-07-31 00:00:00.000000','POL789012',NULL,NULL,'2025-09-20 10:29:49.000000','2025-09-20 10:29:49.000000');
...
-- Dump completed on 2025-09-20 11:16:13
